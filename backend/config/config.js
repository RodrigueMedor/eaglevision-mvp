...
module.exports = {
  app: {
    ...
    sessionSecret: process.env.SESSION_SECRET || (process.env.APP_ENV === 'production' ? null : 'dev-session-secret'),
    jwtSecret: process.env.JWT_SECRET || (process.env.APP_ENV === 'production' ? null : 'dev-jwt-secret')
  },
  email: {
    from: process.env.EMAIL_FROM || (process.env.APP_ENV === 'production' ? null : 'noreply@eaglevisionedge.com'),
