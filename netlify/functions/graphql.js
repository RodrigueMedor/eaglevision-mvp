...
// Health check endpoint - handle both with and without /graphql prefix
app.get(['/health', '/.netlify/functions/graphql/health'], (req, res) => {
  res.status(200).json({ status: 'ok', timestamp: new Date().toISOString() });
});

// Test endpoint - handle both with and without /graphql prefix
app.get(['/test', '/.netlify/functions/graphql/test'], (req, res) => {
