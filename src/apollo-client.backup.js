        ...
        if (refreshTokenValue) {
          ...
          return refreshToken()
            .then(({ access_token, refresh_token }) => {
              ...
              // Safely get the operation context
